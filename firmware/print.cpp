...
#define STREAMOUT  0x10000008
#define STREAMIN   0x10000004
...
{
	return *((volatile uint32_t*)STREAMIN);
}

void write_word(uint32_t out_value)
{
	 *((volatile uint32_t*)STREAMOUT) = out_value;
}
